...
m.withdraw(5000)
puts "^^Tried to withdraw $50.00, transactions are maxed out as you have used #{m.transactions} transactions of #{MoneyMarketAccount::TRANSACTIONS_ALLOWED} transactions allowed. Balance is #{sprintf('$%0.02f', m.balance / 100)}."
